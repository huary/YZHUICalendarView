...
//    self.backgroundColor = PURPLE_COLOR;
    ...
    [self.prevBtn addControlEvent:UIControlEventTouchUpInside actionBlock:^(YZHUIButton *button) {
    ...
    [self.nextBtn addControlEvent:UIControlEventTouchUpInside actionBlock:^(YZHUIButton *button) {
    ...
    self.titleLabel.font = F9_FONT;
    self.titleLabel.textColor = BLACK_C1_COLOR;
