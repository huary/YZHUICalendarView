...
//    SEL addKVOSel = @selector(addKVOObserver:forKeyPath:options:context:);
//    SEL removeSel = @selector(removeObserver:forKeyPath:context:);
//    SEL removeKVOSel = @selector(removeKVOObserver:forKeyPath:context:);
//    
//    Method systemAddMethod = class_getClassMethod([self class], addSel);
//    Method customAddKVOMethod = class_getClassMethod([self class], addKVOSel);
//    Method systemRemoveMethod = class_getClassMethod([self class], removeSel);
//    Method customRemoveKVOMethod = class_getClassMethod([self class], removeKVOSel);
//    
//    method_exchangeImplementations(systemAddMethod, customAddKVOMethod);
//    method_exchangeImplementations(systemRemoveMethod, customRemoveKVOMethod);
//}
